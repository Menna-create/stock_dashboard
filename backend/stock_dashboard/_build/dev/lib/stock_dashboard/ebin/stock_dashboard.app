{application,stock_dashboard,
    [{modules,
         ['Elixir.StockDashboard','Elixir.StockDashboard.Application',
          'Elixir.StockDashboard.Mailer','Elixir.StockDashboard.Repo',
     ...
     {applications,
         [kernel,stdlib,elixir,logger,runtime_tools,plug,phoenix,phoenix_ecto,
          ecto_sql,postgrex,phoenix_html,phoenix_live_reload,
          phoenix_live_view,cors_plug,phoenix_live_dashboard,swoosh,finch,
          telemetry_metrics,telemetry_poller,gettext,finnhub_api,
          phoenix_pubsub,plug_cowboy,jason,dns_cluster,bandit]},
